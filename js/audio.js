...
export function playCue(name,volumeOverride=null){
  ...
  try{const a=new Audio(src);a.volume=typeof volumeOverride==='number'?Math.max(0,Math.min(1,volumeOverride)):(name==='bell'?.32:.23);a.play().catch(()=>{})}catch{}
}
